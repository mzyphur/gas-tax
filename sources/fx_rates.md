# FX rate reference table — v3.2.3 (verified against RBA on 2026-05-11)
...
## Reference rates (used throughout the report — v3.2.3)
...
the v1.1 release corrected that value, and v3.2.3 carries the
...
to 0.130 (× 0.903). The v3.2.3 package carries these corrected
...
*Australia's gas export tax revenue: the definitive accounting* v3.2.3.
